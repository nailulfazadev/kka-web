...
@section('content')
    ...
    {{-- Jadwal Pertemuan --}}
    <section class="px-6 mb-8">
        <h3 class="text-lg font-bold text-on-surface mb-4">Jadwal & Materi Sesi</h3>
        <div class="space-y-3">
        ...
        @else
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                @if($training->whatsapp_link)
                    <a href="{{ $training->whatsapp_link }}" target="_blank" class="flex items-center justify-center gap-2 bg-green-500/10 hover:bg-green-500/20 text-green-600 dark:text-green-400 border border-green-500/20 py-3 rounded-xl font-bold text-sm transition-colors">
