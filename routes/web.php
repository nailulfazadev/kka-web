...
Route::get('/cs/messages', [CSChatController::class, 'messages'])->name('cs.messages');
Route::post('/cs/send', [CSChatController::class, 'send'])->name('cs.send');
...
Route::middleware(['auth', 'role:guru'])->prefix('guru')->name('guru.')->group(function () {
    ...
    Route::post('/pelatihan/{id}/topic/{sessionId}/done', [GuruTrainingController::class, 'markTopicDone'])->name('pelatihan.topic.done');
    Route::get('/pelatihan/{id}/undangan', [GuruTrainingController::class, 'downloadUndangan'])->name('pelatihan.undangan');
    Route::post('/pelatihan/{id}/donasi', [GuruTrainingController::class, 'donasi'])->name('pelatihan.donasi');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/pelatihan/{id}/duplicate', [AdminTrainingController::class, 'duplicateAsEcourse'])->name('pelatihan.duplicate');
